...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_interface.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from my_interface.srv._add_three_ints import AddThreeInts_Request as Request
    from my_interface.srv._add_three_ints import AddThreeInts_Response as Response
